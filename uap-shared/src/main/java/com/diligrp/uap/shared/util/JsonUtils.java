package com.diligrp.uap.shared.util;

import com.diligrp.uap.shared.Constants;
...
public class JsonUtils {
    ...
    public static void initObjectMapperBuilder(Jackson2ObjectMapperBuilder builder) {
        //序列化java.util.Date类型
        builder.dateFormat(new SimpleDateFormat(Constants.DATE_TIME_FORMAT));
        ...
        var dateTimeFormatter = DateTimeFormatter.ofPattern(Constants.DATE_TIME_FORMAT);
        var dateFormatter = DateTimeFormatter.ofPattern(Constants.DATE_FORMAT);
        var timeFormatter = DateTimeFormatter.ofPattern(Constants.TIME_FORMAT);
        // 添加自定义序列化
